...
const COLORS = ["#0088FF", "#00C49F", "#FFBB2B", "#FF8042"]

const Homepage = () => {
    // TODO: set proper projectId
    ...
    return (
        <div className='container h-full w-[100%] bg-gray-100 bg-transparent p-8'>
            ...
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                <div className="rounded-lg bg-white p-4 shadow dark:bg-secondary">
                ...
                <div className="rounded-lg bg-white p-4 shadow dark:bg-secondary md:col-span-2">
                    <h3 className='mb-4 text-lg font-semibold dark:text-white'>
                        Your Tasks
                    </h3>
